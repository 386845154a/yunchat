...
public interface GroupMapper {
	 ...
	 * @return
	 */
	public List<GroupModel> getGroupByName(@Param("userId") String userId, @Param("name") String name);
     ...
     * @return
     */
	public List<?> del_more_filer(@Param("inputTime") Date inputTime, @Param("type") String type);
