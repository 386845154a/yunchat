...
PDFJS.imageResourcesPath = '/js/pdf/images/';
  ...
  ProgressBar.prototype = {
    ...
    setWidth: function ProgressBar_setWidth(viewer) {
      if (viewer) {
        ...
        if (scrollbarWidth > 0) {
          this.bar.setAttribute('style', 'width: calc(100vh - ' +
                                         scrollbarWidth + 'px);');
        }
      }
    },
...
function webViewerInitialized() {
	if (DEFAULT_URL == null){
		var path = $('#fileReadPath').val();
		DEFAULT_URL = '/upDownLoadController/readFile?path=' + encodeURIComponent(path);
	}
